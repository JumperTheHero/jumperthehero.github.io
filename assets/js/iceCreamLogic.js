function createfn() {
    ...
    fetch("https://gist.githubusercontent.com/JumperTheHero/443af8e465b1ce9665b67cb4125fa365/raw/")
        ...
        .then(data => {
            ...
            data.forEach(row => {
                ...
                button.href = "displayImage.html?image=" + row[1] + "&source=IceCream.html";
